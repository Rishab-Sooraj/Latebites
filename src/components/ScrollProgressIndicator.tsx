...
const sections: Section[] = [
    ...
    { id: "how-it-works", label: "How It Works", number: "02" },
    { id: "mystery-bags", label: "Mystery Bags", number: "03" },
    { id: "why", label: "Why Latebites", number: "04" },
    { id: "partner", label: "Partner", number: "05" },
    ...
    return (
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    <div
                        className="relative h-32 w-[2px] rounded-full transition-colors duration-300"
