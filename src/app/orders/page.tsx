        ...
        <div className="relative min-h-screen bg-[#FEFCF9] selection:bg-primary selection:text-primary-foreground overflow-x-hidden">
            ...
            <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
                <motion.div
                    ...
                    className="absolute top-[-10%] right-[-10%] w-[60%] h-[60%] rounded-full bg-gradient-to-br from-primary/10 via-orange-400/5 to-transparent blur-[100px]"
                />
                <motion.div
                    animate={{ scale: [1.1, 1, 1.1], opacity: [0.1, 0.2, 0.1] }}
                    transition={{ duration: 20, repeat: Infinity }}
                    className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-gradient-to-tl from-emerald-500/5 via-teal-400/5 to-transparent blur-[100px]"
                />
            </div>
                    ...
                    <div className="flex flex-col md:flex-row items-end justify-between gap-8 mb-16">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <p className="text-[10px] uppercase tracking-[0.4em] font-black text-primary">Mission History</p>
                            </div>
                            <h1 className="text-5xl md:text-6xl font-serif leading-tight">Your <span className="italic">Rescues</span></h1>
                            <p className="text-muted-foreground font-light text-lg tracking-wide max-w-md">Every bag here represents a step towards a zero-waste city.</p>
                        </motion.div>
                        ...
                        >
                            <Link 
                                href="/browse"
                                className="group flex items-center gap-4 px-8 py-4 bg-white border border-primary/10 rounded-2xl hover:border-primary/40 hover:shadow-2xl transition-all duration-500"
                            >
                                <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
                                <span className="text-[11px] font-black uppercase tracking-[0.2em]">New Rescue Mission</span>
                            </Link>
                        </motion.div>
                    </div>
