    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-36">
            ...
            <div className="relative h-64 md:h-80">
                ...
                <button
                    onClick={() => router.back()}
                    className="absolute top-4 left-4 z-10 w-10 h-10 bg-black/40 backdrop-blur-sm rounded-full flex items-center justify-center"
                ...
                <div className="absolute bottom-0 left-0 right-0 px-4 pb-5 pt-12">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white leading-tight mb-1.5 drop-shadow-lg">
                        {restaurant.name}
                    </h1>
                                        ...
                                        <div className="flex items-start justify-between gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex flex-wrap items-center gap-1.5 mb-2">
                                                    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-xs font-bold text-white bg-gradient-to-r ${config.gradient}`}>
                                                ...
                                                <div className="flex items-baseline gap-1.5">
                                                    <span className="text-xl font-bold text-gray-900">₹{bag.discounted_price}</span>
                                                    <span className="text-sm text-gray-400 line-through">₹{bag.original_price}</span>
                                                    <span className="text-xs text-gray-400 ml-1">{bag.quantity_available} left</span>
                                                </div>
                                            </div>
