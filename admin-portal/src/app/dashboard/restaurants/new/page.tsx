...
export default function NewRestaurantPage() {
    ...
    const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>, type: 'menu' | 'banner') => {
    ...
    const removeImage = (type: 'menu' | 'banner') => {
        if (type === 'menu') {
            setVerification(prev => ({
                ...prev,
                menuImage: null,
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 h-[320px] flex flex-col">
                                    {verification.menuImagePreview ? (
                                        ...
                                        <label className="flex-1 flex flex-col items-center justify-center cursor-pointer border-2 border-dashed border-zinc-700 rounded-lg hover:border-zinc-600 transition-colors">
                                            <Upload className="w-10 h-10 text-zinc-500 mb-3" />
                                            <p className="text-white font-medium text-center px-4">Upload Menu Image</p>
                            ...
                            {/* Banner Image */}
                            <div>
                                <h2 className="text-lg font-medium text-white mb-4">3. Upload Restaurant Banner</h2>
                                <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 h-[320px] flex flex-col">
                                    {verification.bannerImagePreview ? (
                                        <div className="relative flex-1 min-h-0">
                                            <img
                                                src={verification.bannerImagePreview}
                                                alt="Banner preview"
                                        ...
                                        <label className="flex-1 flex flex-col items-center justify-center cursor-pointer border-2 border-dashed border-zinc-700 rounded-lg hover:border-zinc-600 transition-colors">
                                            ...
                                            <p className="text-white font-medium text-center px-4">Upload Banner Image</p>
                                            <p className="text-zinc-500 text-xs mt-1">Wide image suggested</p>
                                            <input
                                                ref={bannerInputRef}
                                                type="file"
                                                accept="image/*"
                        ...
                        <div>
                            <h2 className="text-lg font-medium text-white mb-4">4. Set Restaurant Location</h2>
                        ...
                        <div>
                            <h2 className="text-lg font-medium text-white mb-4">5. Verification Checklist</h2>
                                ...
                                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <div className="flex items-center gap-3 mt-1 underline decoration-zinc-800 underline-offset-4 decoration-2">
                                                {verification.menuImage && <span className="text-emerald-500 text-xs">✓ Menu</span>}
                                                {verification.bannerImage && <span className="text-emerald-500 text-xs">✓ Banner</span>}
                                                {verification.location && <span className="text-emerald-500 text-xs">✓ Location</span>}
                                                {verification.qualityChecked && <span className="text-emerald-500 text-xs">✓ Check</span>}
